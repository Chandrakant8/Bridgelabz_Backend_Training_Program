...
public class GreetingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.equals("/greetings")) {
            ...
            request.getRequestDispatcher("/WEB-INF/views/greetingform.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.equals("/greetings/new")) {
            ...
            Part filePart = request.getPart("imageFile");
            String imagePath = existingImagePath; // Fallback to old path if no new file is uploaded
            if (filePart != null && filePart.getSize() > 0) {
                imagePath = saveUploadedFile(filePart);
